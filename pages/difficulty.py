...
class difficulty_page(Frame):
    ...
    def create_objects(self):
        ...
        self.easy = tk.Button(self, text="Easy", command=self.go_to_easy, width=10, font=(None, 35))
        self.easy.place(x=850, y=250)
        easy_tip = Hovertip(self.easy, "Displays the word's meaning and 3 synonyms")
        self.medium = tk.Button(self, text="Medium", command=self.go_to_medium, width=10, font=(None, 35))
        self.medium.place(x=850, y=350)
        medium_tip = Hovertip(self.medium, "No display")
        self.hard = tk.Button(self, text="Hard", command=self.go_to_hard, width=10, font=(None, 35))
